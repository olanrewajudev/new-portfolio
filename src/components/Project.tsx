    ...
    <div>
      <section id="projects">
        <div className="text-center mb-8">
          <div className="text-yellow font-bold text-xl uppercase">Works</div>
          <div className="lg:text-[4rem] text-[2rem] font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow to-primary">Creative Portfolio</div>
        </div>
        <div className="grid">
