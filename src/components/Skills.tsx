        ...
        <div className="">
          <div className="sm:grid grid-cols-3 lg:grid-cols-7 md:grid-cols-5">
            {skills.map((item, i: number) => (
              <motion.div animate={{ y: [1, -9, 1] }} transition={{ duration: 3, repeat: Infinity, repeatType: "loop", ease: "easeInOut", delay: i * 0.4, }} className="bg-white/30 backdrop-blur-3xl mb-3 text-yellow mx-2 flex flex-col items-center justify-center py-2 rounded-3xl" key={i}>
