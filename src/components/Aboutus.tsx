        ...
        <section id="about-us">
            <div className="border lg:flex items-center p-5 gap-10 rounded-xl">
                ...
                <div className="text-yellow">
                    <div className="bg-clip-text text-transparent bg-gradient-to-r from-yellow to-primary lg:text-[3rem] leading-snug text-2xl font-bold text-">Hello, I’m a FullStack Developer and UX / UI Designer Based in Nigeria.</div>
                    ...
                    <div className="text-yellow lg:flex items-center justify-center gap-5 mt-7">
                        <div className="flex items-center justify-center text-xl gap-2  rounded-full p-4 bg-white/25 backdrop-blur-3xl cursor-pointer hover:text-primary text-center">Download CV<AiOutlineDownload size={24} /></div>
